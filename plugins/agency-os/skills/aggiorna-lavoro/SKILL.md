...
description: Chiude o riallinea una sessione di lavoro aggiornando il second brain PARA e preparando la riconciliazione con Agency OS, applicando soltanto le operazioni certe già autorizzate e chiedendo sui dubbi. Usala per sistemare backlog, stati, inbox, registri e deleghe dopo il lavoro svolto.
---
...
9. **Lotto remoto, certezza e autorizzazione.** Componi il lotto con entità, operazione, valore precedente, valore proposto, prova e rischio, e mostralo per intero. Applica solo le operazioni certe comprese nell’autorizzazione già data dall’utente, seguendo [riconciliazione.md](../agency-os-operations/references/riconciliazione.md). In assenza di autorizzazione o in caso di dubbio, lascia la riga sospesa e poni una domanda esplicita; non ampliare lo scope della chiusura giornata.
...
Chiudi con una nota breve, una riga per voce: salute prima e dopo, con i controlli rimasti rossi · file analizzati e aggiornamenti di sistema · triage in ingresso e memorie aggiunte · stati e backlog toccati, distinti per aree, clienti e progetti · viste rigenerate con peso e righe · età della fotografia Agency OS, disallineamento residuo e copertura non letta · operazioni confermate e righe sospese con domande esplicite · commit e ramo · avvisi e decisioni ancora aperte.
